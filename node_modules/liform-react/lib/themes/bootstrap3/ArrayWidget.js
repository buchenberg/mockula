...
var renderArrayFields = function renderArrayFields(count, schema, theme, fieldName, remove, context) {
        ...
        return _lodash2.default.times(count, function (idx) {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { className: 'pull-right btn btn-danger', onClick: function onClick(e) {
                            e.preventDefault();
                            remove(idx);
                        } },
...
var renderInput = function renderInput(field) {
    return _react2.default.createElement(
        'div',
        { className: 'arrayType form-group' },
        _react2.default.createElement(
            'legend',
